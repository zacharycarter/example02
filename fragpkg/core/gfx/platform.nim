...
when defined(windows):
  const
    bgfxlib* = "bgfx-shared-lib(Debug|Release).dll"
elif defined(macosx):
  const
    bgfxlib* = "libbgfx-shared-lib(Debug|Release).dylib"
else:
  const
    bgfxlib* = "libbgfx-shared-lib(Debug|Release).so"
...
proc bgfx_render_frame*(msecs: int32): bgfx_render_frame_t {.importc: "bgfx_render_frame", dynlib: bgfxlib.}
...
proc bgfx_set_platform_data*(data: ptr bgfx_platform_data_t) {.importc: "bgfx_set_platform_data", dynlib: bgfxlib.}
type
...
proc bgfx_get_internal_data*(): ptr bgfx_internal_data_t {.importc: "bgfx_get_internal_data", dynlib: bgfxlib.}
proc bgfx_override_internal_texture_ptr*(handle: bgfx_texture_handle_t;
                                        `ptr`: pointer): pointer {.importc: "bgfx_override_internal_texture_ptr", dynlib: bgfxlib.}
proc bgfx_override_internal_texture*(handle: bgfx_texture_handle_t; width: uint16;
                                    height: uint16; numMips: uint8;
                                    format: bgfx_texture_format_t; flags: uint32): pointer {.importc: "bgfx_override_internal_texture", dynlib: bgfxlib.}
type
  bgfx_interface_vtbl_t* {.bycopy.} = object
    ...
    encoder_set_marker*: proc (encoder: ptr bgfx_encoder_t; marker: cstring)
    encoder_set_state*: proc (encoder: ptr bgfx_encoder_t; state: uint64; rgba: uint32)
    encoder_set_condition*: proc (encoder: ptr bgfx_encoder_t;
                                handle: bgfx_occlusion_query_handle_t;
                                visible: bool)
    encoder_set_stencil*: proc (encoder: ptr bgfx_encoder_t; fstencil: uint32;
                              bstencil: uint32)
    encoder_set_scissor*: proc (encoder: ptr bgfx_encoder_t; x: uint16; y: uint16;
                              width: uint16; height: uint16): uint16
    encoder_set_scissor_cached*: proc (encoder: ptr bgfx_encoder_t; cache: uint16)
    encoder_set_transform*: proc (encoder: ptr bgfx_encoder_t; mtx: pointer;
                                num: uint16): uint32
    encoder_alloc_transform*: proc (encoder: ptr bgfx_encoder_t;
                                  transform: ptr bgfx_transform_t; num: uint16): uint32
    encoder_set_transform_cached*: proc (encoder: ptr bgfx_encoder_t; cache: uint32;
                                       num: uint16)
    encoder_set_uniform*: proc (encoder: ptr bgfx_encoder_t;
                              handle: bgfx_uniform_handle_t; value: pointer;
                              num: uint16)
    encoder_set_index_buffer*: proc (encoder: ptr bgfx_encoder_t;
                                   handle: bgfx_index_buffer_handle_t;
                                   firstIndex: uint32; numIndices: uint32)
    encoder_set_dynamic_index_buffer*: proc (encoder: ptr bgfx_encoder_t;
        handle: bgfx_dynamic_index_buffer_handle_t; firstIndex: uint32;
        numIndices: uint32)
    encoder_set_transient_index_buffer*: proc (encoder: ptr bgfx_encoder_t;
        tib: ptr bgfx_transient_index_buffer_t; firstIndex: uint32;
        numIndices: uint32)
    encoder_set_vertex_buffer*: proc (encoder: ptr bgfx_encoder_t; stream: uint8;
                                    handle: bgfx_vertex_buffer_handle_t;
                                    startVertex: uint32; numVertices: uint32)
    encoder_set_dynamic_vertex_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stream: uint8; handle: bgfx_dynamic_vertex_buffer_handle_t;
        startVertex: uint32; numVertices: uint32)
    encoder_set_transient_vertex_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stream: uint8; tvb: ptr bgfx_transient_vertex_buffer_t; startVertex: uint32;
        numVertices: uint32)
    encoder_set_vertex_count*: proc (encoder: ptr bgfx_encoder_t; numVertices: uint32)
    encoder_set_instance_data_buffer*: proc (encoder: ptr bgfx_encoder_t;
    ...
    encoder_set_instance_data_from_dynamic_vertex_buffer*: proc (
        ...
        startVertex: uint32; num: uint32)
    encoder_set_texture*: proc (encoder: ptr bgfx_encoder_t; stage: uint8;
                              sampler: bgfx_uniform_handle_t;
                              handle: bgfx_texture_handle_t; flags: uint32)
    encoder_touch*: proc (encoder: ptr bgfx_encoder_t; id: bgfx_view_id_t)
    encoder_submit*: proc (encoder: ptr bgfx_encoder_t; id: bgfx_view_id_t;
                         handle: bgfx_program_handle_t; depth: int32;
                         preserveState: bool)
    encoder_submit_occlusion_query*: proc (encoder: ptr bgfx_encoder_t;
        id: bgfx_view_id_t; program: bgfx_program_handle_t;
        occlusionQuery: bgfx_occlusion_query_handle_t; depth: int32;
        preserveState: bool)
    encoder_submit_indirect*: proc (encoder: ptr bgfx_encoder_t; id: bgfx_view_id_t;
                                  handle: bgfx_program_handle_t; indirectHandle: bgfx_indirect_buffer_handle_t;
                                  start: uint16; num: uint16; depth: int32;
                                  preserveState: bool)
    encoder_set_image*: proc (encoder: ptr bgfx_encoder_t; stage: uint8;
                            handle: bgfx_texture_handle_t; mip: uint8;
                            access: bgfx_access_t; format: bgfx_texture_format_t)
    encoder_set_compute_index_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_index_buffer_handle_t; access: bgfx_access_t)
    encoder_set_compute_vertex_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_vertex_buffer_handle_t; access: bgfx_access_t)
    encoder_set_compute_dynamic_index_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_dynamic_index_buffer_handle_t;
        access: bgfx_access_t)
    encoder_set_compute_dynamic_vertex_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_dynamic_vertex_buffer_handle_t;
        access: bgfx_access_t)
    encoder_set_compute_indirect_buffer*: proc (encoder: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_indirect_buffer_handle_t; access: bgfx_access_t)
    encoder_dispatch*: proc (encoder: ptr bgfx_encoder_t; id: bgfx_view_id_t;
                           handle: bgfx_program_handle_t; numX: uint32;
                           numY: uint32; numZ: uint32; flags: uint8)
    encoder_dispatch_indirect*: proc (encoder: ptr bgfx_encoder_t;
                                    id: bgfx_view_id_t;
                                    handle: bgfx_program_handle_t; indirectHandle: bgfx_indirect_buffer_handle_t;
                                    start: uint16; num: uint16; flags: uint8)
    encoder_discard*: proc (encoder: ptr bgfx_encoder_t)
    encoder_blit*: proc (encoder: ptr bgfx_encoder_t; id: bgfx_view_id_t;
